...
import Ul, { LI } from '../src/components/post/NumbersList';
import { logEvent } from '../src/utils/analytics';

class GamePage extends Component<null> {
  render() {
    return (
      <div>
        <p>
        ...
        <p>
          <strong>
            All I ask you to do is to follow only 4 criteria before you’re going
            to offer me a new role:
          </strong>
        </p>
        <Ul>
          <LI>
